(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_ba69361b._.js", {
...
const productService = {
    ...
    getSellerProducts: async (userId, page = 1, limit = 10)=>{
    ...
    getProductById: async (productId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/products/${productId}`);
        // const response = await axios.get(`/api/products/seller/${productId}`)
        return response.data;
    },
    updateProduct: async (productId, formData)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/products/seller/${productId}`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        });
    ...
    deleteProduct: async (productId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/products/seller/${productId}`);
        return response.data;
    }
};
...
const useProducts = ()=>{
    ...
    const fetchProducts = async (userId, page = 1, limit = 10)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$productService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].getSellerProducts(userId, page, limit);
            if (response.success) {
    ...
    const fetchProductById = async (productId)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$productService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].getProductById(productId);
            if (response.success) {
                return response.data;
            } else {
    ...
    const updateProduct = async (productId, formData)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$productService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].updateProduct(productId, formData);
            if (response.success) {
    ...
    const deleteProduct = async (productId)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$productService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].deleteProduct(productId);
            if (response.success) {
...
function EditProductPage() {
    ...
    const [newImagePreviews, setNewImagePreviews] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
                    ...
                    "EditProductPage.useEffect.fetchData": async ()=>{
                        ...
                        if (product) {
                            const initialData = {
                                ...
                                attributes: product.attributes && product.attributes.length > 0 ? product.attributes : [
                                    {
                                        name: '',
                                        value: ''
                                    }
    ...
    const hasFormChanged = ()=>{
        ...
        return formData.productName !== originalData.productName || formData.mainCategoryId !== originalData.mainCategoryId || formData.subCategoryId !== originalData.subCategoryId || formData.description !== originalData.description || formData.shortDescription !== originalData.shortDescription || formData.price !== originalData.price || formData.stock !== originalData.stock || JSON.stringify(formData.attributes) !== JSON.stringify(originalData.attributes) || newImages.length > 0;
    };
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!user?.userId) return;
        const selectedSubCategory = subCategories.find((cat)=>cat._id === formData.subCategoryId);
        const parentCategoryId = selectedSubCategory ? selectedSubCategory.categoryId || selectedSubCategory.parentId || selectedSubCategory.mainCategoryId || formData.mainCategoryId : formData.mainCategoryId;
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Update the product details"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(site)/products/edit/[id]/page.tsx",
                                        lineNumber: 212,
                                        columnNumber: 29
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    formData.attributes.map((attr, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                formData.attributes.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    type: "button",
                                                                ...
                                                                children: existingImages.map((image, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                                src: `${("TURBOPACK compile-time value", "http://192.168.0.24:9000")}${image}`,
...
_s(EditProductPage, "zaotc2e9Ceu+iD6tpht6WjrFDgs=", false, function() {
    return [
...
//# sourceMappingURL=src_ba69361b._.js.map