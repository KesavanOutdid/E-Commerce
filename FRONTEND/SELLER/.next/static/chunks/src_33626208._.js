(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_33626208._.js", {
...
const SignUp = ()=>{
    ...
    const handleSendOTP = async (e)=>{
        ...
        try {
            ...
            if (response.success) {
                setOtpSent(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`OTP sent to ${formData.email} successfully!`, {
                    duration: 5000,
                    icon: '✉️'
                });
                setStep('register');
    ...
    const handleResendOTP = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].sendOTP(formData.email);
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`New OTP sent to ${formData.email}!`, {
                    duration: 5000,
                    icon: '✉️'
                });
            } else {
...
//# sourceMappingURL=src_33626208._.js.map