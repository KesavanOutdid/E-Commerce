...
"[project]/node_modules/react-server-dom-webpack/cjs/react-server-dom-webpack-client.edge.development.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ "production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function processFullBinaryRow(response, streamState, id, tag, buffer, chunk) {
        ...
        switch(tag){
            ...
            default:
                ...
                } else tag = response._chunks, (chunk = tag.get(id)) ? (resolveChunkDebugInfo(streamState, chunk), resolveModelChunk(response, chunk, buffer)) : (response = createResolvedModelChunk(response, buffer), resolveChunkDebugInfo(streamState, response), tag.set(id, response));
        }
    }
    ...
    function createResponseFromOptions(options) {
        return new ResponseInstance(options.serverConsumerManifest.moduleMap, options.serverConsumerManifest.serverModuleMap, options.serverConsumerManifest.moduleLoading, noServerCall, options.encodeFormAction, "string" === typeof options.nonce ? options.nonce : void 0, options && options.temporaryReferences ? options.temporaryReferences : void 0, options && options.findSourceMapURL ? options.findSourceMapURL : void 0, options ? !0 === options.replayConsoleLogs : !1, options && options.environmentName ? options.environmentName : void 0, options && void 0 !== options.debugChannel ? {
    ...
    var ReactDOM = __turbopack_context__.r("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-dom.js [app-ssr] (ecmascript)"), React = __turbopack_context__.r("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)"), decoderOptions = {
        stream: !0
...
"[project]/node_modules/react-server-dom-webpack/client.edge.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/node_modules/react-server-dom-webpack/cjs/react-server-dom-webpack-client.edge.development.js [app-ssr] (ecmascript)");
}
}}),

};

//# sourceMappingURL=node_modules_react-server-dom-webpack_6d9b2e7c._.js.map