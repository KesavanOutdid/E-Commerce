            ...
            <div>
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex justify-center font-medium text-white bg-blue py-3 px-6 rounded-lg ease-out duration-200 hover:bg-blue/90 mt-6 disabled:bg-gray-4"
                >
                ...
                <Link
                  ...
                  className="block text-center text-dark-4 mt-4 ease-out duration-200 hover:text-dark"
                >
