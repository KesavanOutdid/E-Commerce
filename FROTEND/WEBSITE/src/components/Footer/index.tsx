...
const COMPANY_INFO = {
  ...
  copyrightHolder: "OUTDID UNIFIED PVT LTD"
};
...
const SOCIAL_LINKS = [
  { name: "Facebook", href: "#", label: "Facebook Social Link" },
  { name: "Twitter", href: "#", label: "Twitter Social Link" },
  { name: "Instagram", href: "#", label: "Instagram Social Link" },
  { name: "LinkedIn", href: "https://www.linkedin.com/company/76581299/admin/", label: "Linkedin Social Link" },
  { name: "WhatsApp", href: "https://api.whatsapp.com/send?phone=918095945298", label: "WhatsApp Social Link" }
];
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href={`tel:${COMPANY_INFO.phone}`} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href={`mailto:${COMPANY_INFO.emails.support}`} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              {ACCOUNT_LINKS.map((link) => (
                <li key={link.label}>
                  <a className="ease-out duration-200 hover:text-blue" href={link.href}>
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div className="w-full sm:w-auto">
            <p className="font-medium mb-4">We Accept:</p>
