...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      ...
      <h3 className="font-medium text-dark ease-out duration-200 hover:text-blue mb-1.5 truncate">
        <Link href={`/shop-details/${item.id}`} title={item.title}> {item.title} </Link>
      </h3>
